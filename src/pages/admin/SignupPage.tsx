...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-paper relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute -bottom-24 -left-24 h-96 w-96 rounded-full bg-brand/10 blur-[100px]" />
      ...
      <div className="w-full max-w-md p-8 relative z-10">
        <div className="text-center mb-8 animate-fade-up">
          ...
          <h1 className="text-3xl font-display font-bold text-ink mb-2">Create Admin</h1>
          <p className="text-ink/60">Set up your administrator profile</p>
        </div>
        ...
        <div className="bg-paper border border-ink/10 rounded-3xl p-8 shadow-card animate-fade-up" style={{ animationDelay: "100ms" }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold uppercase tracking-widest text-ink/40 ml-1">Full Name</label>
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-ink/30 transition-colors group-focus-within:text-brand" />
                <input
                  type="text"
                  required
                  value={name}
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-2xl bg-ink/5 border border-ink/5 text-ink placeholder:text-ink/30 focus:bg-paper focus:border-brand/30 focus:outline-none focus:ring-4 focus:ring-brand/5 transition-all"
                />
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-ink/5 text-center">
            <p className="text-sm text-ink/50">
              ...
              <Link to="/admin/login" className="font-bold text-brand hover:underline">Sign In</Link>
            </p>
          </div>
        </div>

        <div className="mt-8 flex items-center justify-center gap-4 animate-fade-up opacity-40 grayscale" style={{ animationDelay: "200ms" }}>
